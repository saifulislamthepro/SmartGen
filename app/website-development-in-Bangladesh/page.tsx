...
export default function WebDev() {
    return(
        <>
            <head>        
                <title>Web Development Services in Bangladesh | SmartGen</title>
                <meta name="description" content="SmartGen offers full-stack web development solutions for businesses in Bangladesh. From resort booking systems to ecommerce platforms, we build it all." />
            </head>
