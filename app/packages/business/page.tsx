    ...
    <>
      ...
      <main className="packages-page">
        <section className="packages-hero">
          ...
          <h2>Most Recommended Package</h2>

        <section className="packages-list">
          <div className="package-card">
            <h3>Business</h3>
            <p className="price">৳ 44,800 / Month</p>
            <div className="list-grid">
              <ul>
                <li>Facebook, Instagram, YouTube, TikTok</li>
                <li>12 Graphics, 4 Reels, 2 Explainer Videos</li>
                <li>20 Copywriting Pieces, 25 Story Shares</li>
                <li>Up to 35 Ad Campaigns</li>
                <li>Influencer Marketing + Monthly Reporting</li>
              </ul>
              <ul>
                <li>Facebook, Instagram, YouTube, TikTok</li>
                <li>12 Graphics, 4 Reels, 2 Explainer Videos</li>
