    ...
    <>
      ...
      <main className="packages-page">
        <section className="packages-hero">
          ...
          <h2>Perfect for Your Brand New Business</h2>

        <section className="packages-list">
          <div className="package-card">
            <h3>Starter</h3>
            <p className="price">৳ 24,800 / Month</p>
            <ul>
              <li>Facebook, Instagram, Google Profile</li>
              <li>8 Graphic Posts, 2 Reels, 1 Motion Graphic</li>
              <li>10 Copywriting Pieces, 15 Story Shares</li>
              <li>Up to 15 Ad Campaigns</li>
              <li>1 Strategy Calendar + 1 Online Meeting</li>
            </ul>
